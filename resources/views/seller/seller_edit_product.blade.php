                            ...
                            <div class="review-tab-pro-inner">
                                ...
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                     <form action="{{ url('/seller-update-product',$product_info->product_id) }}" method="post" enctype="multipart/form-data">
                                            {{csrf_field()}}
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" name="product_name" placeholder="Product Name" required="" value="{{$product_info->product_name}}">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt" >
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" name="product_price" placeholder="Product Price" required="" value="{{$product_info->product_price}}">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-favorites" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" name="product_size" placeholder="Product Size" required="" value="{{$product_info->product_size}}">
                                                    </div>

                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-favorites" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" name="product_color" placeholder="Product Colour" required="" value="{{$product_info->product_color}}">
                                                    </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" name="product_description" placeholder="Product Description" required="" value="{{$product_info->product_description}}">
                                                    </div>
                                                    <!-- <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                        <label class="control-label" for="fileInput"><font color=white>Product Image</font></label>
                                                        <div class="controls">
                                                            <font color=white><input type="file" class="input-file uniform_on" name="product_image" id="fileInput" required="" value="{{$product_info->product_image}}"></font>
                                                        </div>
                                                    </div> -->
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                    <button type="submit" class="btn btn-ctl-bt waves-effect waves-light m-r-10">Update Product
														</button>
                                                </div>
                                            </div>
                                        </div>
